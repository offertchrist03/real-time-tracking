...
function MapCaption() {
  return (
    <section className="lg:px-8 fixed z-[9998] top-0 left-0 flex items-center justify-center w-screen h-screen min-h-full px-6 py-12 pointer-events-none backdrop-brightness-90">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm space-y-3">
        <p className="text-2xl/9 mt-7 font-semibold tracking-tight text-center text-gray-900 pointer-events-auto">
          <span className="px-2 py-1 bg-yellow-500">Connectez vous</span> et
